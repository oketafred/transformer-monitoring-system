...
<html lang="en">
  <head>
    ...
    <title>Admin Area | Analysis</title>
  </head>
  <body>
    <!--Navigation-->
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="list-group">
              ...
              <a href="analysis.php" class="list-group-item list-group-item-action active bg-info"><span class="fa fa-area-chart"></span> Data Analysis</a>
    ...
    <!--Custom Line Grap JS-->
    <script src="ajax_graph/line-graph.js"></script>
