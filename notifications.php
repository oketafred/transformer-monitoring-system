...
<html lang="en">
  <head>
    ...
    <title>Admin Area | Notifications</title>
  </head>
  <body>
    <!--Navigation-->
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="list-group">
              ...
              <a href="notifications.php" class="list-group-item list-group-item-action active bg-info"> <span class="fa fa-bell"> </span> Notification </a>
              ...
              <div class="card-body">
                <!--Inner Website Overview-->
                  <div class="alert alert-primary" role="alert">
                    High Transformer Oil Temperature of 56 <sup>0</sup>C check it out!
                  </div>
